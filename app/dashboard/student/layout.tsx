                ...
                <div className="p-[32px] pb-[16px]">
                    <div className="flex items-center gap-[12px] px-[8px]">
                        <div className="h-[40px] w-[40px] bg-[#015A86] rounded-[12px] flex items-center justify-center shadow-md">
                            <GraduationCap className="h-[24px] w-[24px] text-white stroke-2" />
                        </div>
                        <div>
                            <h1 className="text-[20px] font-bold text-[#0B2E3F] tracking-tight leading-none">Portal</h1>
                            <p className="text-[12px] uppercase font-bold text-[#FD8B0A] tracking-widest mt-[4px]">Learning Hub</p>
                        </div>
                    </div>
                </div>
